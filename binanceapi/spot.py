...
from binanceapi.constant import RequestMethod, Interval, OrderSide, OrderType
...
class BinanceSpotHttp(object):
    ...
    def place_order_test(self, symbol: str, order_side: OrderSide, order_type: OrderType, quantity: float, price: float,
                         client_order_id: str = None, time_inforce="GTC", stop_price=0):
        """
